...
(() => {
  ...
  globalThis.GSTKdb = {
    ...
    replaceNotices: (clientId, source, rows) => call('replaceNotices', clientId, source, rows),
    replaceRefunds: (clientId, rows) => call('replaceRefunds', clientId, rows),
    replaceDrc03: (clientId, rows) => call('replaceDrc03', clientId, rows),
