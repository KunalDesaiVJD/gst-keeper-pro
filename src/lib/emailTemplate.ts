// Corporate email shell for the editor PREVIEW only. Mirror of the Deno copy at
// supabase/functions/_shared/email.ts, which is the source of truth for actually
// sent mail. Keep the two in sync — drift here only affects the preview, never a
// delivered email.
